    ...
    translation: {
      ...
      somatic: {
        ...
        analytics: {
          ...
          topZones: "אזורי גוף פעילים ביותר",
          topSensations: "תחושות נפוצות",
          intensityTrend: "עוצמה לאורך זמן",
          period: {
            "30d": "30 הימים האחרונים",
            "90d": "90 הימים האחרונים",
            "365d": "שנה אחרונה",
          },
          empty: "עדיין לא נרשמו רישומים סומטיים. רישומי הלקוח יופיעו כאן.",
          ...
          csvExportedSuccess: "הניתוחים יוצאו כ-CSV",
          pdfExportedSuccess: "הדוח יוצא כ-PDF",
      ...
      workspace: {
        ...
        addActionItem: "הוסף משימה",
        noWorkspaceFiles: "אין קבצים משותפים עדיין",
        noActionItems: "אין משימות עדיין",
        pendingActionItems: "בהמתנה",
        completedActionItems: "הושלמו",
        createActionItem: "יצור משימה",
        createActionItemDescription: "צור משימה חדשה ללקוח שלך",
        title: "כותרת",
        titlePlaceholder: "הזן כותרת למשימה",
        description: "תיאור",
        descriptionPlaceholder: "הוסף פרטים על משימה זו...",
        dueDate: "תאריך יעד",
        confirmDeleteActionItem: "האם אתה בטוח שברצונך למחוק משימה זו?",
        confirmDeleteFile: "האם אתה בטוח שברצונך למחוק קובץ זה?",
        failedLoadFiles: "נכשלה טעינת קבצים משותפים",
        failedLoadActionItems: "נכשלה טעינת משימות",
        dragOrClick: "לחץ כדי לבחור קובץ או גרור הטל",
        fileTooLarge: "גודל הקובץ חורג מגבול 20MB",
        invalidFileType: "סוג קובץ לא מורשה. נתמך: PDF, תמונות, Word, Excel",
      },
      account: {
      ...
      availability: {
        ...
        bookedSlots: "משבצות מוזמנות",
        heldSlots: "משבצות מוחזקות",
        noSlots: "אין משבצות זמינות בתאריך זה",
        selectDate: "בחר תאריך להצגת פרטים",
        startTime: "שעת התחלה",
        endTime: "שעת סיום",
        timezone: "אזור זמן",
        timezoneDescription:
        ...
        confirmDelete: "האם אתה בטוח שברצונך למחוק את משבצת הזמינות הזו?",
        bookSession: "הזמן הפעלה",
        selectSlot: "צפה בשמות הזמינים של המאמן שלך והזמן הפעלה",
        noAvailableSlots: "אין משבצות זמינות כרגע",
        hold: "החזק",
        book: "הזמן",
        holdExpireTime: "ההחזקה הזו תפוג בעוד 15 דקות",
        noCoachAssigned: "אין לך מאמן מוקצה עדיין",
        contactCoachToBook: "אנא צור קשר עם המאמן שלך כדי להתחיל להזמין הפעלות",
        statusOpen: "פתוח",
        statusHeld: "מוחזק",
        statusBooked: "מוזמן",
